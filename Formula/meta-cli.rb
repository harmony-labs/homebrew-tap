...
class MetaCli < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "75168373911c4a9509817ab67e9c246f080485f9453f98b523793761951347c8"
    end
    on_intel do
      url "https://github.com/harmony-labs/meta/releases/download/v#{version}/meta-darwin-x64.tar.gz"
      sha256 "289b64d4c669d21472fe5fa8af16ea812996bd67439b85760af1467e186c40db"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "3a1d669c903ab87c3cb96a91decb932b12c6e57b6a5049b85c8c0fb52f270f9a"
    end
    on_intel do
      url "https://github.com/harmony-labs/meta/releases/download/v#{version}/meta-linux-x64.tar.gz"
      sha256 "ed4124e892efb5d042a99959a4e13bdf6f57cf10202bd9df7e0b1fd909a20fab"
    end
  end
